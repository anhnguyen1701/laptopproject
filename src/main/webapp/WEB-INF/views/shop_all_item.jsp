			...
			<div class="laptop-list">
				<div class="list-sort">
					...
					<div class="paging pa1">
						<a href="javascript:Shop.goPrev('/shop-all-item/')">Previous</a> <a
							href="/shop-all-item/?page=1">1</a> <a
							href="/shop-all-item/?page=2">2</a> <a
							href="/shop-all-item/?page=3">3</a> <a
							href="/shop-all-item/?page=4">4</a> <a
							href="/shop-all-item/?page=5">5</a> <a
							href="javascript:Shop.goNext('/shop-all-item/')">Next</a>
					</div>
				</div>
				...
				<div class="list-sort">
					...
					<div class="paging mx-auto">
						<a href="javascript:Shop.goPrev('/shop-all-item/')">Previous</a> <a
							href="/shop-all-item/?page=1">1</a> <a
							href="/shop-all-item/?page=2">2</a> <a
							href="/shop-all-item/?page=3">3</a> <a class="pa4"
							href="/shop-all-item/?page=4">4</a> <a class="pa5"
							href="/shop-all-item/?page=5">5</a> <a
							href="javascript:Shop.goNext('/shop-all-item/')">Next</a>
					</div>
				</div>
