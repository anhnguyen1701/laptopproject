					...
					<div class="hoadon">
						...
						<div class="row congty_hoadon">
							<ul class="list-unstyled">
								<li><span class="chuthich">Họ tên khách hàng:</span> <span
									class="tenkhach" style="margin-left: 45px;">${hoa_don.tenKhachHang }</span></li>
								<li><span class="chuthich">Email:</span> <span
									class="thongtin" style="margin-left: 155px;">${hoa_don.email }</span></li>
								<li><span class="chuthich">Điện thoại:</span> <span
									class="thongtin" style="margin-left: 115px;">${hoa_don.soDienThoai }</span></li>
								<li><span class="chuthich">Địa chỉ:</span> <span
									class="thongtin" style="margin-left: 145px;">${hoa_don.diaChi }</span></li>
								<li><span class="chuthich">Hình thức thanh toán:</span> <span
									class="thongtin" style="margin-left: 25px;">${hoa_don.hinhThucThanhToan }</span></li>
								<li><span class="chuthich">Số tài khoản:</span> <span
									class="thongtin" style="margin-left: 100px;"></span></li>
							</ul>
							<hr>
						...
						<div class="row">
							<table class="table">
								...
								<tbody>
									<c:forEach var="item_hoadons"
										items="${hoa_don.hoaDonDanhSachHangs }">
										<tr>
											<td class="tensanpham">
												<div class="row">
													<div class="col-md-5">
														<img
															src="${pageContext.request.contextPath}/files_laptops/${item_hoadons.tenAnh }"
															alt="sanpham">
													</div>
													<div class="col-md-7">
														<h5>${item_hoadons.tenLaptop }</h5>
														<span>Loại sản phẩm: </span>${item_hoadons.tenHangLaptop }
														<br>
													</div>
											...
											<td><fmt:formatNumber type="number" maxFractionDigits="3"
													value="${item_hoadons.giaTien }" />&nbsp;Đ</td>
											<td>${item_hoadons.soLuong }</td>
											<td><fmt:formatNumber type="number" maxFractionDigits="3"
													value="${item_hoadons.tongTienTungLoai }" />&nbsp;Đ</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
