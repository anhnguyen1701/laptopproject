...
<body>
	...
	<!-- MAIN -->
	<div id="main" class="container quanly">
				...
				<div class="card-body">
					<div class="panel-body">
						<form:form modelAttribute="userInfo" action="/register"
							...
							<div class="form-group">
								<c:choose>
									<c:when test="${status=='faileImgNotNull'}">
										<div class="alert alert-danger">
											<strong>Faile!</strong> Ảnh không được để trống!
										</div>
									</c:when>
								</c:choose>
								<label class="required">Chọn ảnh:&ensp;</label> <input
