							...
							<table class="table">
								...
								<tbody id="myTable">
									<c:forEach var="list_hoadons" items="${hoadons }">
										<tr>
											<td width="200px;">${list_hoadons.tenKhachHang }</td>
											<td>${list_hoadons.email }</td>
											<td>${list_hoadons.soDienThoai }</td>
											<td width="250px;">${list_hoadons.diaChi }</td>
											<td width="250px;">${list_hoadons.ngayTao }</td>
											<td width="140px;"><a
